...
RT = SITE['Realtime']['enabled']
TI = SITE['Toonitalia']['enabled']
...
RT_ForwardProxy = SITE['Realtime']['RT_ForwardProxy']
...
RT_PROXY = SITE['Realtime']['RT_PROXY']
TI_PROXY = SITE['Toonitalia']['TI_PROXY']
#Captcha
CAPTCHA = config['Captcha']
UT_ForwardProxy = CAPTCHA['Uprot']['UT_ForwardProxy']
UT_PROXY = CAPTCHA['Uprot']['UT_PROXY']
